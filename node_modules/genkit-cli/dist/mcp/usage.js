...
async function defineUsageGuideTool(server) {
    server.registerTool('get_usage_guide', {
        ...
        description: 'Use this tool to look up the official Genkit usage guide, including project setup instructions and API best practices. ALWAYS call this before implementing Genkit features.',
        inputSchema: {
