...
function defineFlowTools(server, options) {
    ...
    server.registerTool('run_flow', {
        ...
        inputSchema: (0, utils_js_1.getCommonSchema)(options.explicitProjectRoot, {
            flowName: zod_1.default.string().describe('name of the flow; type: string'),
            input: zod_1.default
                .string()
                .describe('Flow input as JSON object encoded as string (it will be passed through `JSON.parse`). Must conform to the schema; type: string.')
                .optional(),
        }),
    }, async (opts) => {
